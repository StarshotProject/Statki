...
//		System.out.println("Sposób podawania wspó³rzêdnych: np. A1");//sprawdzam czy poda³ 2 chary, jeœli tak to sprawdzam, czy pierwszy jest liter¹ z zadanego przedzia³u, a potem czy drugi jest liter¹ z zadanego przedzia³u, jeœli tak to wywo³uje metodê kontroli danych, jeœli zwraca poprawnoœæ jako true, to nastêpuje ustawienie statku na planszy
//		//wersja alternatywna: konwertuje a->1, b->2 itp. - z³e rozwi¹zanie bo tracimy kontrolê wprowadzonych danych,
//		//a skoro i tak musimy j¹ wykonaæ to niech gracz podaje dane w postaci wygodnej dla niego.
//		//konwersje (a->1) nale¿y wykonaæ pod spodem, 
//		//metoda umieszczaj¹ca statki powinna równie¿ uruchomiæ metodê kontroli poprawnoœci danych.
